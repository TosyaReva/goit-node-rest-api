...
import { authSignupSchema, subscriptionSchema, verifySchema } from "../schemas/authSchemas.js";
...
authRouter.post("/verify", isEmptyBody, validateBody(verifySchema), authControllers.resendVerifyEmailController);
